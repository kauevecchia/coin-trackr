      ...
      data: [
        {
          ...
          crypto_symbol: 'BTC',
          crypto_name: 'Bitcoin',
          crypto_quantity: new Decimal(0.5),
          usd_amount: new Decimal(15000),
        ...
        },
        {
          ...
          crypto_quantity: new Decimal(2.0),
          usd_amount: new Decimal(4000),
        ...
        },
        {
          ...
          crypto_symbol: 'BTC',
          crypto_name: 'Bitcoin',
          crypto_quantity: new Decimal(0.2),
          usd_amount: new Decimal(7000),
